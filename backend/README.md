...
## Project Structure
    ...
    ├── testapiautoconnecto_58837  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_58837`
...
2. Clone this repo and `cd testapiautoconnecto_58837`
